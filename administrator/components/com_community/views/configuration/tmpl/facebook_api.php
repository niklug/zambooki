...
<fieldset class="adminform">
	...
	<a href="http://documentation.jomsocial.com/wiki/System_Requirements" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC_REQUIREMENT'); ?></a> | <a href="http://documentation.jomsocial.com/wiki/Setting_up_Facebook_Connect" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC_SETTING_UP'); ?></a>
