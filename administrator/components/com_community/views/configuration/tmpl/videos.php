...
<fieldset class="adminform">
	...
	<a href="http://documentation.jomsocial.com/wiki/Video_Linking_%26_Upload_Requirements" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC_REQUIREMENT'); ?></a> | <a href="http://documentation.jomsocial.com/wiki/Setting_Up_Video_Galleries" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC_SETTING_UP'); ?></a>
...
<fieldset class="adminform">
	...
	<a href="http://documentation.jomsocial.com/wiki/ZenCoder_and_Amazon_S3_Integration" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC'); ?></a>
