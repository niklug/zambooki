...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_FRONTPAGE_EVENT_LIST' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_FRONTPAGE_EVENT_LIST_TIPS'); ?>">
					<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_FRONTPAGE_EVENT_LIST' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'eventfrontpagelist' , null , $this->config->get('eventfrontpagelist') , JText::_('COM_COMMUNITY_UPCOMING_OPTION') , JText::_('COM_COMMUNITY_FEATURED_OPTION') ); ?>
				</td>
			</tr>
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_FRONTPAGE_GROUP_LIST' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_FRONTPAGE_GROUP_LIST_TIPS'); ?>">
					<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_FRONTPAGE_GROUP_LIST' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'groupfrontpagelist' , null , $this->config->get('groupfrontpagelist') , JText::_('COM_COMMUNITY_UPCOMING_OPTION') , JText::_('COM_COMMUNITY_FEATURED_OPTION') ); ?>
				</td>
			</tr>
		</tbody>
	</table>
