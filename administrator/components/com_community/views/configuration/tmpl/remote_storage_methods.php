		...
		<tbody>
			...
			<tr>
				<td width="200" class="key">
					<span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_FILES')?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_FILES_TIPS')?>"> <?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_FILES' )?></span>
				</td>
				<td valign="top">
