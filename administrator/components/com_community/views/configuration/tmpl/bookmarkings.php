...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_SOCIALBOOKMARKS_SHARE_VIA_EMAIL' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_SOCIALBOOKMARKS_SHARE_VIA_EMAIL'); ?>">
