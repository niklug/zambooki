<?php
	...
	class RBidsHelperRoute
	{
		...
		{
                        $CPhotoid = JRequest::getVar('photoid');
                        $CAlbumid = JRequest::getVar('albumid');
                        $tags = JRequest::getString('tags','');
                        
			$link = "index.php?option=com_rbids&photoid={$CPhotoid}&albumid={$CAlbumid}&tags={$tags}&task=form" . self::getItemid(array('task' => 'editauction', 'task' => 'newauction', 'task' => 'form'));
			return JRoute::_($link, $xhtml);
		}
