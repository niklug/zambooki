        ...
        <div class="invitation-wrap clrfix">
            ...
            <div class="invitation-detail">
                ...
                <?php
                    ...
                    ?>
                    <div class="invitation-check">
                        <input type="checkbox" onclick="joms.invitation.selectMemberUnique('#invitation-friend-<?php echo $user->id;?>');" value="<?php echo $user->id;?>" name="friends[]" id="friend-<?php echo $user->id;?>" checked="checked">
                        <label for="friend-<?php echo $user->id;?>"><?php echo JText::_('COM_COMMUNITY_INVITE_SELECTED');?></label>
                    </div>
                <?php
                }
