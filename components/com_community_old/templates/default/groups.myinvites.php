			...
			<div class="cIndex-Box clearfix">
				...
				<div class="cIndex-Content">
					...
					<div class="community-groups-pending-actions">
						<a class="jsIcon1 icon-add-friend cButton cButton-Green" href="javascript:void(0);" onclick="joms.groups.invitation.accept('<?php echo $group->id;?>');"><?php echo JText::_('COM_COMMUNITY_EVENTS_ACCEPT');?></a>
						<a class="icon-remove cButton cButton-Blue" href="javascript:void(0);" onclick="joms.groups.invitation.reject('<?php echo $group->id;?>');"><?php echo JText::_('COM_COMMUNITY_EVENTS_REJECT');?></a>
					</div>
