				...
				<ul class="cFormList cFormVertical cResetList">
					...
					<li class="has-seperator">
						<div class="form-field">
							...
							<input type="submit" class="cButton" value="<?php echo JText::_('COM_COMMUNITY_SAVE_BUTTON'); ?>" class="button" onclick="saveContent();" />
							<input type="button" class="cButton" onclick="joms.groups.editBulletin();return false;" value="<?php echo JText::_('COM_COMMUNITY_CANCEL_BUTTON'); ?>" />
						</div>
					</li>
				</ul>
			</form>
