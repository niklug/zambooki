		...
		<div class="cGrid-Info">
            ...
            <div class="cGrid-Check">
                <label for="friend-<?php echo $user->id;?>" class="label-checkbox">
                    <input type="checkbox" onclick="joms.invitation.selectMemberUnique('#invitation-friend-<?php echo $user->id;?>');" value="<?php echo $user->id;?>" name="friends[]" id="friend-<?php echo $user->id;?>" <?php echo $invited ? 'checked="checked"' : ''; ?>">
