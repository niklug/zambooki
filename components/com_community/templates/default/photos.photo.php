     ...
     */ ?>
        ...
        <div id="cGallery">
            <script type="text/javascript">
                        ...
                        var jsPlaylist = {
                album: <?php echo JRequest::getVar('albumid'); ?>,
                        photos:	[
    <?php
    for ($i = 0; $i < count($photos); $i++) {
        ...
        <?php foreach ($photo->tagged as $tagItem) { ?>
                        ...
                        id:     <?php echo $tagItem->id; ?>,
                                ...
                                tags: '<?php echo $tagItem->position; ?>',
                                displayTop: null,
                                displayLeft: null,
                                displayWidth: null,
                                displayHeight: null,
    ...
    <?php if ($default) { ?>
        ...
        <?php if (intval($config->get('photosgalleryslider'))) { ?>
                    ...
                    <div class="photoActions">
                        <div class="photoAction _next" onclick="joms.gallery.displayPhoto(joms.gallery.nextPhoto()); joms.photos.photoSlider.switchPhoto();"><img src="" height="50" width="50" alt="" /></div>
