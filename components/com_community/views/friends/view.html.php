...
class CommunityViewFriends extends CommunityView
{
	...
	public function invite()
	{
		...
		$user		= CFactory::getUser($id);
		$sorted		= $jinput->get->get('sort' , 'suggestion', 'STRING'); //JRequest::getVar( 'sort' , 'suggestion' , 'GET' );
		$filter		= $jinput->get->get('filter' , 'suggestion', 'STRING'); //JRequest::getVar( 'filter' , 'suggestion' , 'GET' );
		$friends 	= CFactory::getModel( 'friends' );
